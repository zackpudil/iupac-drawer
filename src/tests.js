export const tests = [
  ...
  '2-propyl-3-(1-ethylpropyl)-2,6-diethyl-4-(1,1-dimethylethyl)-5-(2-propenyl)octane', // 6
  ...
  '2-methyl-3-(2,3-diethyl-2-butenyl)-5-octene', // 16
  ...
  '2-(2,3,4-triethyl-2,4-hexadienyl)-4-octyne', // 21
  '2-(2,3,4-triethyl-2,4,6-heptatrienyl)-5,3-decadiyne' // 22
];
